...
mapping={'th':0,'thou':0,'in':1,'inch':1,'ft':2,'foot':2,'yd':3,'yard':3,'ch':4,'chain':4,'fur':5,'furlong':5,'mi':6,'mile':6,'lea':7,'league':7}
inp=input().split(' ')
...
if amount.is_integer(): print('%.f' %(amount))
else: print('%.9f' %(amount))
